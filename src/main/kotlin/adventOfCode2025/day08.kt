...
private const val MAX_CONNEXION = 1000
private const val NB_LARGEST_CIRCUITS = 3
...
fun main() {
    ...
    for (i in 0 until MAX_CONNEXION) {
    ...
    val largestCircuits = circuits.sortedBy { it.size }.reversed().take(NB_LARGEST_CIRCUITS)

    val magicNumber = largestCircuits.fold(1) { acc, list -> acc * list.size }
